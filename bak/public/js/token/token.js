...
define(['kmap', 'jquery','bootbox', 'bootstrapTable', 'bootstrapTableZh'], function(kmap, $, bootbox){
    var module = {};
    ...
    /*function operateFormatter(){
        return '<a title="删除" href="javascript:;" class="link-red remove-token"><span class="glyphicon glyphicon-remove"></span></a>';
    }*/
    function filterNameList(str){
        $('#table-list-ul li').css('display', '');
        str && $('#table-list-ul li').not(':contains(' + str + ')').css('display', 'none');
    }
});