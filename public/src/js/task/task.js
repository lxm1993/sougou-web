...
var template = _.template('<table class="parser-table"><tr><th>ID</th><th>URL</th><th>表ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>创建者</th><th>版本</th></tr>' +
    ...
    '<td><a href="/data/list-instance-data?tableId=<%= item.tableId %>"><%= item.tableId %></a></td>' +
    '<td> <%= item.creator %></td>' +
...
function operateFormatter(value, row, index){
    ...
    var name = row.taskId || '';
    var result =  ['<a title="修改" href="javascript:;" class="link-blue edit-task"><span class="glyphicon glyphicon-pencil"></span></a>',
        '&nbsp;&nbsp;&nbsp;',
        '<a title="删除" href="javascript:;" class="link-red delete-task"><span class="glyphicon glyphicon-remove"></span></a>',
        '&nbsp;&nbsp;&nbsp;',
