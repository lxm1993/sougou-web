...
/***/ function(module, exports, __webpack_require__) {
	...
	function operateFormatter(value, row, index) {
	    ...
	    result += '&nbsp;&nbsp;&nbsp;<a title="删除" href="javascript:;" class="link-red remove-user"><span class="glyphicon glyphicon-remove"></span></a>' + '&nbsp;&nbsp;&nbsp;<a title="查看token信息" href="/token/list-token?username=' + row.username + '" class="link-green"><span class="glyphicon glyphicon-th-list"></span></a>';
	    return result;
	}
