...
/***/ function(module, exports, __webpack_require__) {
	...
	function buildTable() {
	    ...
	    function urlFormatter(value, row, index) {
	        ...
	        var urlStr = '<a href="' + parseHref + '">' + row.parser_url + '</a>' + '&nbsp;&nbsp;<a title="调试" href="javascript:;" data-table-id="' + row.table_id + '" class="link-green parser-debug"><span class="glyphicon glyphicon-expand" style="top:3px"></span></a>';
	        return urlStr;
	    }
	    function operateFormatter(value, row, index) {
	        console.dir(row);
	        var parseHref = "/parser/edit-parser?url=" + encodeURIComponent(row.parser_url);
	        var editParser = '<div style="width: 100px"><a title="编辑" ' + 'href="' + parseHref + '" class="link-blue">' + '<span class="glyphicon glyphicon-pencil"></span>' + '</a>';
	        var deleteParser = '&nbsp;&nbsp;&nbsp;<a title="删除" href="javascript:;"' + ' data-parse-id="' + row.id + '" class="link-red remove-parser">' + '<span class="glyphicon glyphicon-remove"></span>' + '</a>';
	        var runParser = '&nbsp;&nbsp;&nbsp;<a title="解析" href="/parser/diff-parser" class="link-green">' + '<span class="glyphicon glyphicon-play"></span>' + '</a>' + '</div>';
